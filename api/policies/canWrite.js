module.exports = function canRead (req, res, next) {
  ...
  if (req.user) {
    ...
    //for all other resources
      ...
      console.log("now will try to ",action, "with userid", ownerId || userId);
      if (action === "create" || userId || ownerId) { //ownerId is equivalent of userId, is the one user who made the resource/has full access. NO RECORD SHOULD HAVE BOTH ownerId AND userId!!
