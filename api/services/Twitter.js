...
const _setup = (account, accessTokenData) => {
  const Twit = new T({
    consumer_key: process.env.TWITTER_CONSUMER_KEY || sails.config.env && sails.config.env.TWITTER_CONSUMER_KEY,
    consumer_secret: process.env.TWITTER_CONSUMER_SECRET || sails.config.env && sails.config.env.TWITTER_CONSUMER_SECRET,
