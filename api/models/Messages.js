...
module.exports = {
  ...
  attributes: {
    ...
    messageUrl: { type: 'string'},// (link they can follow);
    messageKey: { type: 'string'},// (LI gives it, others might too, for updating the message)
    ...
    messageTemplateId: { model: 'messageTemplates', required: 'true'},
  },
